<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hukuk.aspx.cs" Inherits="hukuk" %>
...
<body>
    ...
    <div>
     <table class="table">
            <tr>
                <td><asp:Image ID="Image1" runat="server"  ImageUrl="~/Icon/HUKUK MUSAVIRLIGI_2.jpg" /></td>
            </tr>
        </table>
    </div>
    </form>
